<div class="grid grid-cols-1 md:grid-cols-2 gap-6">
    ...
    <div>
        ...
        <input type="text" wire:model.debounce.500ms="searchAgregados" placeholder="Buscar..." class="w-full border p-2 mb-3">
    ...
    <div>
        ...
        <input type="text" wire:model.debounce.500ms="searchDisponibles" placeholder="Buscar..." class="w-full border p-2 mb-3">
