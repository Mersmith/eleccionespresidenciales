...
<div x-data="dataCandidatoSocial">
    ...
    <div class="formulario">
        ...
        <div class="g_fila" x-data="{ globalVisible: true, itemsVisibility: Array({{ count($contenido) }}).fill(true) }">
            <div class="g_columna_12">
                <div class="g_panel">
                    ...
                    <div x-sort="handleCandidatoSocial">
        ...
        <div>
            <div class="formulario_botones">
                <button wire:click="guardarCandidatoSocial" class="guardar">Guardar</button>
            </div>
        </div>
    </div>

    <script>
        function dataCandidatoSocial() {
            return {
                handleCandidatoSocial(item, position) {
                    console.log(item, position);

                    Livewire.dispatch('handleCandidatoSocialOn', {
                        item: item,
                        position: position,
                    });
                },
