...
<div x-data="dataSocialAlianza">
    ...
    <div class="g_panel cabecera_titulo_pagina">
        ...
        <div class="cabecera_titulo_botones">
            ...
            <a href="{{ route('admin.alianza.vista.editar', $alianza->id) }}" class="g_boton g_boton_darkt">
    ...
    <div class="formulario">
        ...
        <div class="g_fila" x-data="{ globalVisible: true, itemsVisibility: Array({{ count($contenido) }}).fill(true) }">
            <div class="g_columna_12">
                <div class="g_panel">
                    ...
                    <div x-sort="handleAlianzaSocial">
        ...
        <div>
            <div class="formulario_botones">
                <button wire:click="guardarAlianzaSocial" class="guardar">Guardar</button>
            </div>
        </div>
    </div>

    <script>
        function dataSocialAlianza() {
            return {
                handleAlianzaSocial(item, position) {
                    //console.log(item, position);

                    Livewire.dispatch('handleAlianzaSocialOn', {
                        item: item,
                        position: position,
                    });
                },
