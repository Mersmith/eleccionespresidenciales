...
use App\Livewire\Admin\Candidato\CandidatoCargoEquipoLivewire;
...
Route::get('/candidato/cargo-equipo/{id}', CandidatoCargoEquipoLivewire::class)->name('candidato.cargo.equipo.editar');
