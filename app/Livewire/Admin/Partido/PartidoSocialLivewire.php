...
class PartidoSocialLivewire extends Component
{
    public $partido;
    ...
    public function mount($id)
    {
        ...
        if ($this->partido->redes_sociales) {
            $this->contenido = json_decode($this->partido->redes_sociales, true);
        } else {
            $this->contenido = [
                [
                    'id' => 1,
    ...
    #[On('handlePartidoSocialOn')]
    public function handlePartidoSocialOn($item, $position)
    {
    ...
    public function guardarPartidoSocial()
    {
        $this->validate();
    ...
    {
        return view('livewire.admin.partido.partido-social-livewire');
    }
}
